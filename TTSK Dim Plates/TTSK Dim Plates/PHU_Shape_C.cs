    ...
    public class ShapeCScript
    {
            ...
            ModelPart part)
        {
            ...
            try
            {
                ...
                {
                    result.Message =
                        "Khong co drawing de precheck Auto Section Shape C.";
                    return result;
                }
                ...
                {
                    result.Message =
                        "Khong ket noi duoc model de precheck Auto Section Shape C.";
                    return result;
                }
                ...
                {
                    result.Message =
                        "Khong co part Shape C hop le de precheck Auto Section.";
                    return result;
                }
                ...
                {
                    result.Message =
                        "Khong tim thay view chua Shape C de precheck Auto Section.";
                    return result;
                }
                ...
                View topViewByType = FindViewByViewTypeForC(
                    views,
                    "TopView",
                    "Top");
                View frontViewByType = FindViewByViewTypeForC(
                    views,
                    "FrontView",
                    "Front");
                View bottomViewByType = FindViewByViewTypeForC(
                    views,
                    "BottomView",
                    "Bottom");
                ...
                if (resolvedTopView == null &&
                    result.SpecialTopSections.Count > 0)
                    resolvedTopView = result.SpecialTopSections[0];

                View resolvedBottomView = bottomViewByType;
                if (resolvedBottomView == null &&
                    result.SpecialBottomSections.Count > 0)
                ...
                result.HasPartialSectionLayout =
                    ...
                    (!hasCompleteLayoutForDrawing ||
                     hasAmbiguousSpecialSection);
                ...
                {
                    result.Message =
                        "Khong xac dinh duoc FrontView Shape C bang ViewType.";
                    return result;
                }
                ...
                {
                    result.Message =
                        "Khong the hoan tat precheck lo Top/Bottom Shape C.";
                }
            ...
            {
                result.Message =
                    "Precheck Auto Section Shape C loi: " + ex.Message;
            }
            ...
            out int usedRightVerticalTierCount)
        {
            ...
            try
            {
                ...
                Point leftHorizontalHole =
                    FindCShapeAssemblyFrontNearestEdgeHole(leftEndHoles, false);
                Point rightHorizontalHole =
                    FindCShapeAssemblyFrontNearestEdgeHole(rightEndHoles, true);
                Point leftVerticalHole =
                    FindCShapeAssemblyFrontVerticalRepresentativeHole(leftEndHoles, false);
                Point rightVerticalHole =
                    FindCShapeAssemblyFrontVerticalRepresentativeHole(rightEndHoles, true);
            ...
            out List<Point> rightEndHoles)
        {
            ...
            try
            {
                ...
                if (clusters.Count == 1)
                {
                    ...
                    List<Point> target = Math.Abs(centerX - minX) <= Math.Abs(maxX - centerX)
                        ? leftEndHoles
                        : rightEndHoles;
        ...
        private static void AddCShapeAssemblyFrontHoles(
            List<Point> target,
            List<Point> source)
        {
        ...
        private static Point FindCShapeAssemblyFrontNearestEdgeHole(
            List<Point> holes,
            bool isRight)
        {
            Point best = null;
            ...
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(profile))
                {
                    ...
                    object profileObject = profileProperty != null
                        ...
                        : null;
                    PropertyInfo profileStringProperty = profileObject != null
            ...
            List<View> exactSectionViews)
        {
            try
            {
                ...
                {
                    View topSection = FindAutoSectionCandidateForC(
                        views,
                        frontView,
                        true);
                ...
                {
                    View bottomSection = FindAutoSectionCandidateForC(
                        views,
                        frontView,
                        false);
            ...
            bool aboveFront)
        {
            ...
            try
            {
                ...
                foreach (View view in views)
                {
                    ...
                    double sectionWidth =
                        GetViewRestrictionBoxWidthForC(view);
        ...
        private static void RemoveViewForC(
            List<View> views,
            View view)
        {
