...
namespace Tekla.Technology.Akit.UserScript
{
    public class Script
    {
        ...
        // AUTO HOLE MARK SHORTEST LEADER + COLLISION AVOIDANCE.
        // Tất cả khoảng hở dưới đây là paper-space; khi chạy sẽ nhân với view scale.
        private const bool AUTO_ARRANGE_HOLE_MARKS_SHORTEST = true;
        ...
        public static void Run(Tekla.Technology.Akit.IScript akit)
        {
            ...
            // BƯỚC 3C: Chọn vị trí hole mark có leader ngắn nhất nhưng không đè
            // dimension line, đường gióng hay hộp mark khác. Góc leader không ép
            // cứng; chạy sau khi DIM + style mark đã ổn định để dùng box thật.
            if (AUTO_ARRANGE_HOLE_MARKS_SHORTEST)
            {
                AutoArrangeHoleMarksShortest(model, drawing, part, processedViews);
...
#pragma warning restore 618
        ...
        #region 07B - HOLE MARK SHORTEST LEADER / DIMENSION COLLISION AVOIDANCE
        ...
        private static void AutoArrangeHoleMarksShortest(
            Model model,
            Drawing drawing,
            ModelPart part,
            List<View> views
            ...
            try
            {
                ...
                foreach (View view in views)
                {
                    ...
                    try
                    {
                        ...
                        AutoArrangeHoleMarksShortestInView(
                            drawing,
                            view,
                            holeGroups,
                            minX,
        ...
        private static void AutoArrangeHoleMarksShortestInView(
            Drawing drawing,
            View view,
        ...
        )
        {
            ...
            // Các số hạng sau chỉ phá hòa ở cấp rất nhỏ. Chúng không được phép
            // thắng một ứng viên có leader ngắn hơn nhìn thấy được trên giấy.
            ...
            double positionTieBreak =
                ...
                * 0.000000001;
            candidate.Score = candidate.LeaderLength
                + anchorTieBreak
                + sideTieBreak
                + positionTieBreak;
        }
