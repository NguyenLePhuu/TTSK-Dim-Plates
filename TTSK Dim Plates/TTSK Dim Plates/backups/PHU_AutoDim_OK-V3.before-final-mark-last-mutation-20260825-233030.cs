...
namespace Tekla.Technology.Akit.UserScript
{
    public class Script
    {
        ...
        public static void Run(Tekla.Technology.Akit.IScript akit)
        {
            ...
            // BƯỚC 6B: Tekla có thể tự đặt lại LeaderLine mark khi view vừa bị move.
            // Chạy lại đúng planner sau lần dịch view cuối để vị trí MARK lỗ trên/
            // dưới đã chọn không bị cơ chế auto placing của Tekla ghi đè.
            if (AUTO_ARRANGE_HOLE_MARKS_AESTHETIC)
            {
                AutoArrangeHoleMarksAesthetic(model, drawing, part, processedViews);
                SafeCommitAndWait(drawing, 120);
