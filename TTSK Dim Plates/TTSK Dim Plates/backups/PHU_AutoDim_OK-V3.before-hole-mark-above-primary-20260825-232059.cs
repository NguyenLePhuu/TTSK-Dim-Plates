...
namespace Tekla.Technology.Akit.UserScript
{
    public class Script
    {
        ...
        // Ưu tiên mềm đưa box mark lên phía trên bản vẽ. Không khóa cứng:
        // ứng viên dưới vẫn được dùng khi phía trên va chạm hoặc xấu/dài hơn rõ rệt.
        private const double HOLE_MARK_SAME_LEVEL_PENALTY_PAPER = 3.0;
        private const double HOLE_MARK_BELOW_PENALTY_PAPER = 6.0;
...
#pragma warning restore 618
        ...
        private sealed class HoleMarkCandidateV3
        {
            ...
            public double VerticalPreferencePenalty;
            public double Score;
        }
        ...
        )
        {
            ...
            // Trong hệ tọa độ drawing/view đang dùng, Y nhỏ hơn hiển thị cao hơn
            // trên tờ bản vẽ. Dùng tâm box (không dùng Side) để mark nằm bên trái
            ...
            candidate.VerticalPreferencePenalty = 0.0;
            if (candidate.VerticalPreferenceRank == 1)
            {
                candidate.VerticalPreferencePenalty =
                    Math.Max(1.0, scale) * HOLE_MARK_SAME_LEVEL_PENALTY_PAPER;
            }
            else if (candidate.VerticalPreferenceRank == 2)
            {
                candidate.VerticalPreferencePenalty =
                    Math.Max(1.0, scale) * HOLE_MARK_BELOW_PENALTY_PAPER;
            }
