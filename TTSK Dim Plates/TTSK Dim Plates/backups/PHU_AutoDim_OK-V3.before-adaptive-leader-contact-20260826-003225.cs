...
#pragma warning restore 618
        ...
        )
        {
            ...
            candidate.Contact = new Point(
                candidate.Center.X + item.LeaderContactOffset.X,
                candidate.Center.Y + item.LeaderContactOffset.Y,
                0
            );
        ...
        )
        {
            ...
            if (side == 0 || side == 3)
            {
                ...
                if (contactOffset != null)
                    contactCoordinate += (side == 0 ? height * 0.5 : -height * 0.5)
                        + contactOffset.Y;
                ...
                double centerX;
                if (contactOffset != null)
                    centerX = contactX - contactOffset.X;
            ...
            else
            {
                ...
                if (contactOffset != null)
                    contactCoordinate += (side == 1 ? -width * 0.5 : width * 0.5)
                        + contactOffset.X;
                ...
                double centerY;
                if (contactOffset != null)
                    centerY = contactY - contactOffset.Y;
